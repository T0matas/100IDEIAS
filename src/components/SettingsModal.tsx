      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[850px] h-[600px] bg-[#0F0F0F] border border-white/10 rounded-[1.5rem] shadow-2xl flex overflow-hidden"
          >
            {/* Sidebar */}
            <div className="w-[240px] border-r border-white/5 bg-[#0A0A0A] p-6 flex flex-col">
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-between">
                      <div className="flex items-center gap-5">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-2xl font-bold text-white shadow-xl overflow-hidden">
                          {avatarUrl ? (
                      ...
                      <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-bold text-white transition-all"
                      >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="text-sm font-medium text-white">{userEmail || "danieltomatas0@gmail.com"}</p>
                            <p className="text-xs text-gray-500">Email</p>
                          </div>
                        </div>
                        <span className="px-2.5 py-1 rounded-lg bg-white/5 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Primary</span>
                      </div>
                    </div>
                  </div>
                )}
